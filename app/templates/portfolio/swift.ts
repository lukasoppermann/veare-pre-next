  ...
  <page-section centered class="o-project-section-container">
    <div class="Grid">
      ...
      <div class="Grid--columns">
        <img src="/${cache.get('files').media['media/swift-logo.jpg']}" alt="Swift logo design" />
      </div>
      <div class="old-project-grid-image-main">
        <img src="/${cache.get('files').media['media/swift-logo-construction.jpg']}" alt="Swift logo constrcution" class="u-full-width" />
      </div>
      ...
      <div class="old-project-grid-image-side-start">
        <img src="/${cache.get('files').media['media/swift-pattern_01.jpg']}" alt="Corporate Patterns" class="u-full-width" />
      </div>
      <div class="old-project-grid-image-side">
        <img src="/${cache.get('files').media['media/swift-pattern_02.jpg']}" alt="Corporate Patterns" class="u-full-width" />
      </div>
      <h3 class="o-headline--h2 o-headline--portfolio Grid--columns">Stationeries</h3>
      <div class="Grid--columns">
        <img src="/${cache.get('files').media['media/swift-stationeries.jpg']}" alt="Stationeries in Corporate Design" class="u-full-width" />
      </div>

      <h3 class="o-headline--h2 o-headline--portfolio Grid--columns">Architecture & Vehicles</h3>
      <div class="old-project-grid-image-main">
        <img src="/${cache.get('files').media['media/swift-car.jpg']}" alt="vehicle with corporate colors & elements" class="u-full-width" />
      </div>
      <div class="old-project-grid-image-side">
        <img src="/${cache.get('files').media['media/swift-flags.jpg']}" alt="Swift flag design" class="u-full-width" />
      </div>
      <div class="old-project-grid-image-side-start">
        <img src="/${cache.get('files').media['media/swift-checkin.jpg']}" alt="swift help desk" class="u-full-width" />
      </div>
