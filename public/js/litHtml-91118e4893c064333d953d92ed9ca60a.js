...
/**
     ...
     * subject to an additional IP rights grant found at
     * http://polymer.github.io/PATENTS.txt
     */;const S=new class{handleAttributeExpressions(t,e,s,n){const i=e[0];if("."===i){return new b(t,e.slice(1),s).parts}if("@"===i)return[new A(t,e.slice(1),n.eventContext)];if("?"===i)return[new V(t,e.slice(1),s)];return new N(t,e,s).parts}handleTextExpression(t){return new w(t)}};
/**
     * @license
     * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
     * This code may only be used under the BSD style license found at
     ...
     * subject to an additional IP rights grant found at
     * http://polymer.github.io/PATENTS.txt
     */function $(t){let e=L.get(t.type);void 0===e&&(e={stringsArray:new WeakMap,keyString:new Map},L.set(t.type,e));let s=e.stringsArray.get(t.strings);if(void 0!==s)return s;const n=t.strings.join(r);return s=e.keyString.get(n),void 0===s&&(s=new h(t,t.getTemplateElement()),e.keyString.set(n,s)),e.stringsArray.set(t.strings,s),s}const L=new Map,H=new WeakMap;
/**
     * @license
     * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
     * This code may only be used under the BSD style license found at
...
/**
     ...
     * http://polymer.github.io/PATENTS.txt
     */
"undefined"!=typeof window&&(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.3.0");const C=new WeakMap,k=(P=t=>e=>{if(!(e instanceof w))throw new Error("unsafeHTML can only be used in text bindings");const s=C.get(e);if(void 0!==s&&v(t)&&t===s.value&&e.value===s.fragment)return;const n=document.createElement("template");n.innerHTML=t;const i=document.importNode(n.content,!0);e.setValue(i),C.set(e,{value:t,fragment:i})},(...e)=>{const s=P(...e);return t.set(s,!0),s});
/**
     * @license
     * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
     * This code may only be used under the BSD style license found at
     ...
     * subject to an additional IP rights grant found at
     * http://polymer.github.io/PATENTS.txt
     */var P;window.app.html=(t,...e)=>new f(t,e,"html",S),window.app.render=(t,e,s)=>{let i=H.get(e);void 0===i&&(n(e,e.firstChild),H.set(e,i=new w(Object.assign({templateFactory:$},s))),i.appendInto(e)),i.setValue(t),i.commit()},window.app.unsafeHTML=k}();
