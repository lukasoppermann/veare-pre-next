...
/**
     ...
     * subject to an additional IP rights grant found at
     * http://polymer.github.io/PATENTS.txt
     */;const S=new class{handleAttributeExpressions(t,e,s,n){const i=e[0];if("."===i){return new V(t,e.slice(1),s).parts}return"@"===i?[new T(t,e.slice(1),n.eventContext)]:"?"===i?[new y(t,e.slice(1),s)]:new x(t,e,s).parts}handleTextExpression(t){return new w(t)}};
/**
     * @license
     * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
     * This code may only be used under the BSD style license found at
