...
A smart device is not a heating system that is controlled via smartphone but

A smart home is not equal to

Yet, many companies are still building apps like this. Why? The main reason is a misunderstanding of what a **smart device** actually is. Contrary to the believe of many, the idea is **not** to make everything controllable via smartphone.
